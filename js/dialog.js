...
(function () {
  ...
  function injecterStyle() {
    ...
    s.id = STYLE_ID;
    s.textContent = [
      '.dlg-overlay{position:fixed;inset:0;background:rgba(16,42,67,.25);backdrop-filter:blur(4px);',
        'display:flex;align-items:center;justify-content:center;padding:16px;',
        'z-index:9999;animation:dlgFond .12s ease;}',
      '@keyframes dlgFond{from{opacity:0}to{opacity:1}}',
      '.dlg-carte{background:#fff;color:#102a43;',
        'border:1px solid rgba(184,216,248,.25);border-radius:12px;',
        'padding:18px 18px 16px;max-width:420px;width:100%;',
        'box-shadow:0 20px 60px rgba(16,42,67,.18);',
        "font-family:Inter,system-ui,sans-serif;animation:dlgPop .14s ease;}",
      ...
      '.dlg-input{width:100%;background:#fff;color:#102a43;',
        'border:1px solid rgba(184,216,248,.35);border-radius:10px;padding:10px 12px;',
        "font-family:Inter,sans-serif;font-size:1.05rem;margin-bottom:14px;box-sizing:border-box;}",
      '.dlg-actions{display:flex;gap:10px;justify-content:flex-end;flex-wrap:wrap;}',
      '.dlg-btn{cursor:pointer;border:none;border-radius:10px;min-height:44px;padding:9px 16px;',
        "font-family:Inter,sans-serif;text-transform:none;",
        'letter-spacing:.5px;font-weight:600;font-size:1rem;}',
      '.dlg-ok{background:#155b91;color:#fff;}',
      '.dlg-ok:hover{background:#2477bd;}',
      '.dlg-ok.dlg-danger{background:#c0392b;}',
      '.dlg-ok.dlg-danger:hover{background:#a93226;}',
      '.dlg-annuler{background:#f4f7fa;color:#102a43;',
