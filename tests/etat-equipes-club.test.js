...
const panneau={getAttribute:()=> 'Club Test',querySelectorAll:()=>choix.map(value=>({value})),
...
c.rechargerEquipes=async()=>{refresh++};
(async()=>{
 ...
 // Une nouvelle réponse du club retire la preuve serveur et réactive l'ajout.
 ...
 // Un succès sans marque serveur ne prouve jamais que les équipes sont ajoutées.
